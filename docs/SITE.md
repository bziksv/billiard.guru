...
- **Стратегия i18n, этапы и чеклисты:** [`docs/I18N.md`](./I18N.md) и правило `.cursor/rules/i18n-strategy.mdc`.
- **English first:** `/en/…`, cookie `NEXT_LOCALE`, без русского контента на EN-URL.
