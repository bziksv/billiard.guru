...
|-------------------|------|
| 0 | нет |
| 0,5 | 1 шар в **чётных** партиях |
| 1,0 | 1 шар в **каждой** партии |
| 1,5 | 1 шар каждую + 1 шар в чётных |
...
- **`/admin/club-news`** — модерация публикаций от клубов (Telegram: одобрить / отклонить).
- Колонка **«Рассылка»** — задел под платную рассылку новости игрокам города в мессенджеры ([MONETIZATION.md](./MONETIZATION.md)).
