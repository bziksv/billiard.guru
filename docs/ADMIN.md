...
Формат **«Сетка на 16 до 2 поражений, олимпийка с 1/4 с двумя 3 местами»** (`FIXED_SWISS`) — **эталон** отрисовки и логики для остальных фиксированных сеток. Регламент для разработки: [`BRACKET_REFERENCE_16_8.md`](./BRACKET_REFERENCE_16_8.md). После правок links/шаблона в коде — **«Сформировать заново»** на странице турнира.
