...
Формат **`FIXED_SWISS_32`** — **эталонная** сетка для 32 участников: **59 встреч**, 10 колонок, нижняя тур 1–4, олимпийка с 1/8. Регламент: [`BRACKET_REFERENCE_32_16.md`](./BRACKET_REFERENCE_32_16.md).
...
Формат **`FIXED_SWISS_64`** — **эталонная** сетка для 64 участников: **119 встреч**, 11 колонок, нижняя тур 1–4, oлимпийка с 1/8. Регламент: [`BRACKET_REFERENCE_64_32.md`](./BRACKET_REFERENCE_64_32.md).
