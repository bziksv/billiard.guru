...
export async function generateMetadata({
  ...
  return buildLocalizedStaticMetadata("clubs", locale);
}
...
export default async function ClubsPage({
          ...
          {nothingFound ? (
            ...
            <>
              <section className="space-y-4">
                ...
                {localClubs.length === 0 ? (
                  <p className="text-sm text-zinc-500">
                    {t("pages.clubs.emptyInCity", { city: player.city.nameRu })}
                  </p>
                ) : (
              ...
              {nearbyClubs.length > 0 && (
                <section className="space-y-4">
                  <h2 className="site-page-subtitle">
                    {t("pages.clubs.nearby")}
                    <span className="home-card-muted ml-2 text-base font-normal">
                      {t("pages.clubs.nearbyCities")}
                    </span>
                  </h2>
  ...
  return (
    <>
      <PageHeader title={t("nav.clubs")} lead={t("pages.clubs.leadDefault")} />
