...
/**
 * Переопределить (или сбросить) рейтинг участника/пары. До старта — влияет на посев;
 * во время турнира — на фору в предстоящих/текущих встречах. Для одиночных — solo-команда.
 */
