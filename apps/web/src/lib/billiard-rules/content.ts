...
export const BILLIARD_GENERAL_SECTIONS: GuideSection[] = [
  {
    ...
    paragraphs: [
      "На billiard.guru по умолчанию фора считается по разнице рейтингов с шагом 0,5 без округления вверх: при разнице меньше 0,5 форы нет; от 0,5 — полный шар в каждой партии и/или дополнительный шар в чётных. Сильнейшему назначается «минус».",
