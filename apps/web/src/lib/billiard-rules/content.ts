...
export const BILLIARD_GENERAL_SECTIONS: GuideSection[] = [
  {
    ...
    paragraphs: [
      "На billiard.guru по умолчанию фора считается по разнице рейтингов с шагом 0,5: полный шар в каждой партии, при дробной разнице — дополнительный шар в чётных партиях. Сильнейшему назначается «минус».",
