...
export function getDefaultBracketParticipantRules(
  ...
  if (code === "FIXED_SWISS_128R8_2_3_mesta") {
    return {
      ...
      label: "ровно 128",
      hint:
        "Сетка «до 2 поражений» на 128 участников — 247 встреч, oлимпийka с 1/8: проигравшие в 1/8 сразу на места 33–48. " +
  ...
  if (code === "FIXED_SWISS_128R8_1_3_mesto") {
    return {
      ...
      label: "ровно 128",
      hint:
        "Сетка «до 2 поражений» на 128 участников — 248 встреч (247 + матч за 3–4 #248), oлимпийka с 1/8: проигравшие в 1/8 сразу на места 33–48. " +
        "Добавьте участников до 128 или смените формат.",
    };
  }
