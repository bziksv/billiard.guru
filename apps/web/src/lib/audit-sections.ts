...
export const AUDIT_ACTION_LABELS: Record<string, string> = {
  ...
  "play_listing.create": "Новое объявление",
  "play_listing.update": "Изменено объявление",
  "play_listing.delete": "Удалено объявление",
  "play_listing.respond": "Отклик на объявление",
  "play_listing.response_update": "Изменён отклик",
  "club.news.submit": "Новость на модерацию",
  "club.news.approve": "Новость одобрена",
  "club.news.reject": "Новость отклонена",
  "club.news.unpublish": "Новость снята",
  "tournament.register": "Регистрация на турнир",
  "tournament.register.self": "Самостоятельная регистрация",
  "tournament.team.register": "Регистрация пары",
  "tournament.team.update": "Изменена пара",
  "tournament.bracket.generate": "Сетка построена",
  "tournament.bracket.regenerate": "Сетка перестроена",
  "tournament.bracket.delete": "Сетка удалена",
  "tournament.bracket.reset": "Сетка сброшена",
  "tournament.match.result": "Результат матча",
  "tournament.match.cancel": "Отмена результата",
  "site.news.publish": "Новость сервиса",
  "site.news.unpublish": "Новость снята",
  "site.news.republish": "Новость опубликована",
  "site.news.delete": "Новость удалена",
