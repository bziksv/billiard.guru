...
export const NOTIFICATION_CATALOG = [
  ...
  },
  {
    ...
    description:
      "Участникам матча при первом назначении времени начала (кнопка «Начать» / сохранение startedAt). Правка времени повторно не шлётся.",
    category: "tournaments",
    kind: "outbound",
    channel: "telegram",
    recipient: "Игроки обеих сторон встречи (с telegramId), только если обе стороны уже известны",
    trigger: "PATCH /api/tournaments/bracket — первое поле startedAt у матча",
  ...
  },
  {
    ...
    kind: "outbound",
    channel: "telegram",
    recipient: "Клуб (telegramId) и сотрудники с Telegram",
  ...
  {
    id: "player-booking-confirmed",
    title: "Бронь подтверждена клубом",
    description: "Игроку после подтверждения заявки на стол в кабинете клуба.",
    category: "bookings",
    kind: "outbound",
    channel: "telegram",
    recipient: "Игрок (player.telegramId)",
    trigger: "PATCH брони → status CONFIRMED",
    implementation: "player-booking-notify.ts → notifyPlayerBookingConfirmed()",
    hasButtons: true,
    auditAction: "table_booking.notify.confirmed",
    triggeredBy: ["club-booking-new"],
    examplePreview: "✅ Бронь подтверждена…",
    manageable: true,
    templatePlaceholders: ["clubName", "table", "tableHint", "time", "link"],
  },
  {
    id: "player-booking-rejected",
    title: "Бронь отклонена клубом",
    description: "Игроку, если клуб отклонил заявку на стол.",
    category: "bookings",
    kind: "outbound",
    channel: "telegram",
    recipient: "Игрок",
    trigger: "PATCH брони → status REJECTED",
    implementation: "player-booking-notify.ts → notifyPlayerBookingRejected()",
    hasButtons: true,
    auditAction: "table_booking.notify.rejected",
    triggeredBy: ["club-booking-new"],
    examplePreview: "❌ Бронь отклонена…",
    manageable: true,
    templatePlaceholders: ["clubName", "table", "tableHint", "time", "link"],
  },
  {
    id: "player-booking-cancelled",
    title: "Бронь отменена клубом",
    description: "Игроку, если клуб отменил ранее подтверждённую бронь.",
    category: "bookings",
    kind: "outbound",
    channel: "telegram",
    recipient: "Игрок",
    trigger: "PATCH брони → status CANCELLED (клубом)",
    implementation: "player-booking-notify.ts → notifyPlayerBookingCancelledByClub()",
    hasButtons: true,
    auditAction: "table_booking.notify.cancelled",
    triggeredBy: ["club-booking-new"],
    examplePreview: "❌ Бронь отменена клубом…",
    manageable: true,
    templatePlaceholders: ["clubName", "table", "tableHint", "time", "link"],
  },
  {
