...
const BRACKET_FORMAT_SEO: Record<BracketFormatCode, BracketFormatSeoEntry> = {
  ...
  FIXED_SWISS_32R8_2_3_mesta: {
    ...
    metaDescription:
      "Турнирная сетка на 32 участника: 55 встреч, олимпийка с 1/8 — проигравшие в 1/8 сразу на места 9–12.",
    lead: "Фиксированная сетка на 32: 55 встреч, 9 колонок, олимпийка с 1/8 — вылет с 1/8 на места 9–12, без нижней тур 4.",
    participantBadge: "32 человека",
    keywords: [
  ...
  FIXED_SWISS_64R8_1_3_mesto: {
    ...
    metaDescription:
      "Турнирная таблица на 64: олимпийка с 1/8 (111 встреч) и отдельный матч #120 за 3–4 место. Демо на billiard.guru.",
  ...
  FIXED_SWISS_128R8_2_3_mesta: {
    ...
    metaDescription:
      "Турнирная сетка на 128 участников: 215 встреч, олимпийка с 1/8 — проигравшие в 1/8 сразу на места 33–48.",
    lead: "Фиксированная сетка на 128: 215 встреч, олимпийка с 1/8 — вылет с 1/8 на места 33–48, без нижней тур 4; полуфиналисты делят 3-е.",
  ...
  FIXED_SWISS_128R8_1_3_mesto: {
    ...
    metaDescription:
      "Турнирная таблица на 128: олимпийка с 1/8 (215 встреч) и отдельный матч #216 за 3–4 место. Демо на billiard.guru.",
  ...
  FIXED_SWISS_8R4_1_3_mesto: {
    ...
    metaDescription:
      "Турнирная таблица на 8 с олимпийкой с 1/4 и матчем за бронзу (#14). Демо 14 встреч на billiard.guru.",
    lead: "Сетка 8→4 (13+1 встреч) с олимпийкой с 1/4 плюс матч #14 за 3–4 между проигравшими полуфиналистами.",
  ...
  FIXED_SWISS_8R2_1_3_mesto: {
    ...
    pageTitle: "Сетка на 8 человека с 1/2 и матчем за 3–4 место",
    metaTitle: "Сетка на 8 человека (1/2) + матч за 3–4",
    metaDescription:
      "Турнирная таблица на 8: олимпийка с 1/2, нижняя сетка до 4-го места, матч #13 за бронзу и финал #14. Демо на billiard.guru.",
    lead: "Сетка 8→4 (14 встреч) с олимпийкой с 1/2: полуфинал #7–#8, нижний тур до #12, матч #13 за 3–4, финал #14.",
    participantBadge: "8 человек",
    keywords: ["сетка 8 полуфинал", "турнирная таблица 8 1/2", "матч за 3 место 8 игроков"],
  },
  FIXED_SWISS_16R4_2_3_mesta: {
    code: "FIXED_SWISS_16R4_2_3_mesta",
    slug: "setka-16-chelovek-1-4",
    pageTitle: "Турнирная сетка на 16 человека — олимпийка с 1/4",
    metaTitle: "Турнирная сетка на 16 человека — до 2 поражений, 1/4",
    metaDescription:
      "Турнирная таблица на 16 с олимпийкой с 1/4: 27 встреч, проигравшие полуфиналисты делят 3-е место. Демо на billiard.guru.",
    lead: "Сетка 16→8 (27 встреч) с олимпийкой с 1/4 — проигравшие полуфиналисты получают 3-е место без дополнительной игры.",
  ...
  FIXED_SWISS_16R4_1_3_mesto: {
    ...
    metaDescription:
      "Турнирная таблица на 16 с олимпийкой с 1/4 и матчем за бронзу (#28). Демо 28 встреч на billiard.guru.",
    lead: "Сетка 16→8 (27+1 встреч) с олимпийкой с 1/4 плюс матч #28 за 3–4 между проигравшими полуфиналистами.",
    participantBadge: "16 человек",
  ...
  FIXED_SWISS_16R2_1_3_mesto: {
    ...
    metaDescription:
      "Турнирная таблица на 16: олимпийка с 1/2 (24 встречи), проигравшие полуфинала играют #28 за 3–4.",
  ...
  FIXED_SWISS_256R8_1_3_mesto: {
    ...
    metaDescription:
      "Турнирная таблица на 256: олимпийка с 1/16 (496 встреч) и матч #496 за 3–4 место. Демо на billiard.guru.",
...
export function bracketFormatDisplayLabel(code: BracketFormatCode): string {
  ...
  if (code === "FIXED_SWISS_8R2_1_3_mesto") return FIXED_SWISS_8R2_1_3_mesto_FORMAT_LABEL;
