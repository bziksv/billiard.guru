...
const BRACKET_FORMAT_SEO: Record<BracketFormatCode, BracketFormatSeoEntry> = {
  ...
  FIXED_SWISS_32R8_2_3_mesta: {
    ...
    metaDescription:
      "Турнирная сетка на 32 участника: 59 встреч, олимпийка с 1/8 (#41–#44). Демо на billiard.guru.",
    lead: "Фиксированная сетка на 32: 59 встреч, 10 колонок, олимпийка с 1/8 финала — вылет с 1/8.",
    participantBadge: "32 человека",
    keywords: [
      "турнирная сетка 32",
      "сетка на 32 человека",
