...
const BRACKET_FORMAT_SEO: Record<BracketFormatCode, BracketFormatSeoEntry> = {
  ...
  FIXED_SWISS_32: {
    ...
    metaDescription:
      "Турнирная сетка и таблица на 32 участника: 59 встреч, эталон LLB 32→16. Демо-схема и создание турнира на billiard.guru.",
  ...
  FIXED_SWISS_64: {
    ...
    metaDescription:
      "Турнирная сетка и таблица на 64 участника: 119 встреч, эталон LLB 64→32. Демо-схема и создание турнира на billiard.guru.",
  ...
  FIXED_PAIR_SWISS_32: {
    ...
    lead: "Парный аналог эталона LLB 32→16 — 59 встреч для команд из двух игроков.",
