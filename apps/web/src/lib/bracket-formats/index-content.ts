...
export const BRACKET_INDEX_TEASER: Record<string, string> = {
  ...
  FIXED_SWISS_8R4_1_3_mesto:
    "8 участников, олимпийка с 1/4 и матч #14 за бронзу между полуфиналистами.",
  FIXED_SWISS_16R4_2_3_mesta:
    "16 участников, олимпийка с 1/4 — проигравшие полуфиналисты делят 3-е место без доп. игры.",
  FIXED_SWISS_16R4_1_3_mesto:
    "16 участников, олимпийка с 1/4 и матч #28 за бронзу между полуфиналистами.",
  FIXED_SWISS_16R2_1_3_mesto:
    "16 участников, олимпийка с 1/2 (без 1/4) — проигравшие полуфинала падают на #28 за 3–4.",
  ...
  FIXED_SWISS_256R8_1_3_mesto: "256 участников, олимпийка с 1/16 + матч за 3–4 (#456).",
