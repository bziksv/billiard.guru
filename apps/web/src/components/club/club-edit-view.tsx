      ...
      <div className="flex items-start gap-6 lg:gap-10">
        ...
        <label className="block text-sm">
          ...
          <input
            ...
            placeholder="Московский проспект, 102В"
          />
          <p className="mt-1 text-xs text-zinc-500">
            Улица и дом без города — город уже выбран в профиле клуба. Не указывайте корпус
            (к1, к2), если клуб в основном здании. Координаты для карты определятся при
            сохранении.
          </p>
        </label>
